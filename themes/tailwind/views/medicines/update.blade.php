...
@endif
  <li><a href="#">Đổi mật khẩu</a></li>
      ...
      <div class="profile-info">
        <h3>Nhập thuốc vào kho</h3>
        <form action="{{ route('medicines.updateStock') }}" method="POST">
            @csrf
            <div class="form-row">
                <div class="form-group">
                    <label for="medicine_id">Chọn thuốc:</label>
                    <select name="medicine_id" id="medicine_id" required class="search-input">
                ...
                <div class="form-group">
                    <label for="quantity">Số lượng thêm:</label>
            ...
            <div class="form-row">
                <div class="form-group">
                    <label for="expiration_date">Hạn sử dụng mới:</label>
