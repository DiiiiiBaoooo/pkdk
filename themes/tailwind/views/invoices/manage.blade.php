                    ...
                    @else
                        @foreach($invoices as $index => $invoice)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('invoices.show', $invoice->invoice_id) }}" class="btn btn-sm btn-info">Xem chi tiết</a>
                                    @if($invoice->status == 'pending')
                                        <form action="{{ route('invoices.updateStatus', $invoice->invoice_id) }}" method="POST" style="display: inline;">
                                            @csrf
                                            @method('PUT')
