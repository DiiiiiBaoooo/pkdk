                ...
                <table>
                    ...
                    <tbody>
                        @foreach($medicalRecords as $record)
                            <tr>
                                <td>{{ Carbon\Carbon::parse($record->appointment->time)->format('d/m/Y') }}</td>
                                <td>{{ $record->diagnosis ?? 'Chưa có kết quả' }}</td>
                                <td>{{ $record->appointment->status }}</td>
                               <td>
    <a href="{{ route('prescription.show', [$record->appointment->appointment_id, $record->medical_record_id]) }}" class="view-prescription-link">
        Xem chi tiết
    </a>
</td>
                            </tr>
