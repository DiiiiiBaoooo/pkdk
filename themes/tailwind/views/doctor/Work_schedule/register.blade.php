...
@endif
  <li><a href="#">Đổi mật khẩu</a></li>
        ...
        <form method="POST" action="{{ route('doctor.work-schedule.store', ['doctor_id' => Auth::user()->doctors->doctor_id]) }}">
    @csrf
    ...
    <input type="hidden" name="doctor_id" value="{{ Auth::user()->doctors->doctor_id }}">
